#cineplusNataly
#aplicacion basica de cobro para un cine creada para python con wxglade. consta de 4 ventanas: inicio de secion sin coneccion BD, taquilla, dulceria y tiket
#!/usr/bin/env python3
# -*- coding: UTF-8 -*-
#
...
class ventana4(wx.Frame):
    def __init__(self, prent, informacion="", subtotal1=0, informacion2="", subtotal2=0):
        ...
        label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, "Taquilla", style=wx.ALIGN_CENTRE_HORIZONTAL)
        ...
        label_4 = wx.StaticText(self.panel_1, wx.ID_ANY, "Dulceria",style=wx.ALIGN_CENTRE_HORIZONTAL)
        ...
        lbTotal = wx.StaticText(self.panel_1, wx.ID_ANY, f"Total: ${self.subtotalDulceria+self.subtotalTaquilla}")
...
class ventana2(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.cmbPelicula = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=["pilm pilm", "masha y el oso", "five nights freddy2"], style=wx.CB_DROPDOWN)
    ...
    def seleccionPelicula(self, event):  # wxGlade: ventana2.<event_handler>
        ...
        if pelicula == "pilm pilm":
            imagen="pelicula1.png"
            sala="1"
            horario1="14:00"
            horario2="17:00"
            horario3="20:00"
        elif pelicula == "masha y el oso":
            imagen="pelicula2.png"
            sala="2"
            horario1="13:30"
            horario2="16:30"
            horario3="19:30"
        elif pelicula == "five nights freddy2":
...
class ventana1(wx.Frame):
    ...
    def confirmar_usuario_clave(self, event):  # wxGlade: ventana1.<event_handler>
        ...
        if nombre =="nataly"and clave == "123":
